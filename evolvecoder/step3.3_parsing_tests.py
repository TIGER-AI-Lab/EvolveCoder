...
def filter_parsed_items(item):
    ...
    """
    gpt_response = item['synthesis_result_first'].get('gpt_response', None)
    tests = item['synthesis_result_first'].get('tests', None)
...
def main(
    ...
    def parsing_item(item):
        ...
        item['synthesis_result_first']['tests'] = tests
...
"""
python acecoderv3_fine_grained_test_cases/step3.3_parsing_tests.py acecoderv3/outputs/all_20/gpt_4.1_mini/step3.2_gen_tests_results_round_1.jsonl --round 1 --num_proc 1
"""