...
"""
python acecoderv3_fine_grained_test_cases/step3.8_eval.py acecoderv3_fine_grained_test_cases/outputs/all_20_round1/gpt_4.1_mini/step3.7_parsing_tests_round_1.jsonl --round 1

# With custom batch size and timeout (auto-restart enabled by default)
python acecoderv3_fine_grained_test_cases/step3.8_eval.py input.jsonl --round 1 --batch_size=50 --batch_timeout=1800

# Disable auto-restart (manual restart required)
python acecoderv3_fine_grained_test_cases/step3.8_eval.py input.jsonl --round 1 --auto_restart=False

# Force overwrite (clear cache)
python acecoderv3_fine_grained_test_cases/step3.8_eval.py input.jsonl --round 1 --overwrite=True

# Example with 30 minute timeout per batch and auto-restart
python acecoderv3_fine_grained_test_cases/step3.8_eval.py input.jsonl --round 1 --batch_timeout=1800 --auto_restart=True
"""